...
import com.example.radardetector.RadarMapActivity
import com.example.radardetector.db.DatabaseHelper
import com.example.radardetector.math.ProcessedLocationMetrics
import com.example.radardetector.math.RadarMath
import com.example.radardetector.math.TrajectoryFilter
import com.example.radardetector.model.MushroomTrack
import com.example.radardetector.model.TrackPoint
...
class RadarForegroundService : Service(), LocationListener, SensorEventListener {
    ...
    companion object {
        ...
        const val ACTION_START_RECORDING = "com.example.radardetector.ACTION_START_RECORDING"
        const val ACTION_STOP_RECORDING = "com.example.radardetector.ACTION_STOP_RECORDING"
