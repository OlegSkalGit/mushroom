package com.olegskal.mushroom.receiver
...
class AlarmWatchdogReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_ALARM_WATCHDOG = "com.olegskal.mushroom.ACTION_ALARM_WATCHDOG"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (RadarForegroundService.isRunning) {
            ...
            try {
                ...
                com.olegskal.mushroom.util.ServiceUtils.startRadarForegroundService(context, serviceIntent)
