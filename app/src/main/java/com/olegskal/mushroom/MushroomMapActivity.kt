    ...
    private fun showHelpDialog() {
        ...
        if (isUk) {
            ...
            addSection(
                ...
                "• Що завантажується: архів моделі нейромережі model.zip (~60 МБ). Автоматично розпаковується один раз кнопкою «Завантажити».\n" +
            ...
            addSection(
                ...
                "  — Комплексний фільтр: одночасний вибір їстівності (🟢 Їстівні, 🔴 Неїстівні) та будови гіменофора (🧽 Трубчасті, 🍂 Пластинчасті, 🍄 Інші).\n" +
                ...
                "• Режим роботи: ГІБРИДНИЙ (підтримує як онлайн з iNaturalist, так і повністю автономну роботу через локальну SQLite базу mushrooms.db ~538 МБ)."
            )
            addSection(
            ...
            addSection(
                ...
                "  ✓ Одноразове завантаження архіву моделі нейромережі model.zip (~60 МБ).\n" +
                "  ✓ Одноразове завантаження локальної бази енциклопедії mushrooms.db (~538 МБ).\n" +
            ...
            addSection(
                ...
                "• What is Downloaded: model.zip neural network archive (~60 MB), auto-unpacked once via 'Download' button.\n" +
            ...
            addSection(
                ...
                "  — Combined Filter: simultaneous selection of edibility (🟢 Edible, 🔴 Inedible) and hymenophore (🧽 Tubes, 🍂 Gilled, 🍄 Other).\n" +
                ...
                "• Operating Mode: HYBRID (supports both online browsing via iNaturalist and 100% offline encyclopedia via mushrooms.db ~538 MB SQLite database)."
            )
            addSection(
            ...
            addSection(
                ...
                "  ✓ One-time download of local encyclopedia database mushrooms.db (~538 MB).\n" +
